...
flowchart TD
  ...
  S4[ヒトデータ審査委員会による審査]
  S5[承認後 Submission ID の発行]
  S6[メタデータの作成（英）とデータファイルの準備]
  S7[メタデータとデータファイルアップロード]
  S8[キュレーターによる検証後アクセッション番号の発行]
  S8[データ公開日が決定次第ヒトデータ審査委員会事務局へ通知]
  S9[NBDC ヒトデータベース専用サイトの公開とデータ公開]
