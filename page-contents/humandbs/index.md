...
データの提供にはデータ提供申請が必要です。**ヒトデータ審査委員会**による審査承認後、指定されたアーカイブへデータを登録します。
...
- NBDC ヒトデータベース申請システムにて「データ提供申請グループ」の作成
  - データ提供申請の際の研究代表者、申請者、データアップロード担当者全員をグループに含める
  - Owner権限が付与されているメンバが、権限の付与やメンバ招待をすることができる
...
- NBDCヒトデータベースポータルサイトにおいて利用を希望するデータセットを選定し「カートに追加」する
  ...
  - データセットのアクセスレベル（制限公開 Type I または Type II）を確認し、必要なセキュリティ対策を整える
    - [NBDCヒトデータ取扱いセキュリティガイドラインチェックリスト（データ利用者向け）](https://humandbs.dbcls.jp/public-files/guidelines/data-sharing-guidelines/security_checklist_for_users.xlsx)をダウンロードし、セキュリティ対策実施状況を記載する
...
- NBDC ヒトデータベース申請システムにて「データ利用申請グループ」の作成
  ...
  - Owner権限が付与されているメンバが、PI 権限の変更やメンバ招待をすることができる
...
- **年次報告**：データ利用期間が複数年にわたる研究の場合、年に 1 度の進捗報告が必要
  ...
  - [申請開始] ボタンの左側にあるセレクトボックスから**データ利用報告申請**を選択し、申請書を作成・申請する
    - データ利用報告時点でのセキュリティ対策実施状況について、NBDCヒトデータ取扱いセキュリティガイドラインチェックリスト（データ利用者向け）をダウンロードして記載のうえ添付する
...
- [セキュリティガイドライン (利用者向け) Ver. 7.0](https://humandbs.dbcls.jp/guidelines/security-guidelines-for-users)
