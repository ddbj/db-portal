...
> ddbj-search-api 0.3.0 で Tier 3 allowlist 25 unique field を公開済み。**残るは BioSample 5 / SRA 3 / JGA 2 / BioProject 1 = 11 field** の API allowlist 化のみ（[ddbj-search-api 側で対応待ち](#-ファーストリリースで追加予定)）。
