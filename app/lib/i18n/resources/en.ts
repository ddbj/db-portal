...
export const en: Resources = {
  ...
  submit: {
    ...
    flow: {
      ...
      "bioproject": { title: "BioProject", description: "Companion metadata grouping the whole project.", cta: "Open submission form" },
      "biosample": { title: "BioSample", description: "Companion metadata grouping your samples.", cta: "Open submission form" },
      "dra": { title: "DRA", description: "Deposits sequencing reads as runs and analyses.", cta: "Start submission" },
      "jga": { title: "JGA", description: "Deposits controlled-access human data under a policy.", cta: "Start submission" },
      "ddbj-trad": { title: "DDBJ Trad", description: "Bulk-submits assembled nucleotide sequences via MSS.", cta: "Start submission" },
      "nsss": { title: "NSSS", description: "Web-based nucleotide sequence submission system.", cta: "Start submission" },
      "togovar": { title: "TogoVar", description: "Deposits public human variants.", cta: "Start submission" },
      "gea": { title: "GEA", description: "Deposits gene expression and spatial data.", cta: "Start submission" },
      "metabobank": { title: "MetaboBank", description: "Deposits mass spectrometry, NMR, and metabolite data.", cta: "Start submission" },
      "humandbs": { title: "NBDC Human Database", description: "Apply for and obtain the data-use policy for controlled-access human data (operated by DBCLS).", cta: "Apply for policy" },
      "jpost": { title: "jPOST", description: "Submit proteomics data here instead (outside DDBJ).", cta: "Open jPOST" },
