...
export const en: Resources = {
  ...
  submit: {
    ...
    detail: {
      ...
      options: {
        ...
        spatialTranscriptomics: {
          visium: { label: "Visium", sub: "Sequencing-based (DRA + GEA two-step submission)" },
          xenium: { label: "Xenium", sub: "In situ imaging (no DRA submission needed)" },
          merfish: { label: "MERFISH", sub: "In situ imaging (no DRA submission needed)" },
          stereoSeq: { label: "Stereo-seq", sub: "Sequencing-based (DRA + GEA two-step submission)" },
        },
        massSpectrometry: {
    ...
    access: {
      ...
      "restrictedPreference": { label: "Prefer restricted access", sub: "Sharing among researchers approved by the Data Access Committee" },
      "hasIdentifier": {
      ...
      "publiclyAvailable": { label: "Publicly available specimens", sub: "Specimens widely available for research use, beyond commercial products and in compliance with applicable laws" },
      "microbialAnalysis": { label: "Human sequences removed", sub: "Analysis of the microbes or viruses themselves isolated from the human body, with human sequences removed" },
    ...
    flow: {
      ...
      "dra": {
        title: "DRA",
        description: "Deposits raw NGS reads (FASTQ/BAM) and their analyses.",
        prereqLabel: "Submit raw sequencing reads to DRA",
      },
      "jga": { title: "JGA", description: "Deposits controlled-access human data." },
  ...
  search: {
    ...
    builder: {
      ...
      predicateHelp: {
        eq: "Searches for records that exactly match the entered value",
        notEq: "Searches for records that do not match the entered value",
        contains: "Splits the input into space-separated words and searches for records containing any of them",
        notContains: "Searches for records that contain none of the entered words",
        wildcard: "* matches any string, ? matches any single character. Example: DRA*",
        notWildcard: "Searches for records that do not match the pattern",
        between: "Searches for records within the specified range",
        notBetween: "Searches for records outside the specified range",
      },
      predicateHelpLabel: "Operator help",
      rangeFromLabel: "FROM",
      rangeToLabel: "TO",
    ...
    assistant: {
      ...
      generateError: "Could not generate a query.",
      retry: "Try again",
    },
    scope: {
      all: "All databases",
